            ...
            react_1.default.createElement(components_1.Container, { style: container },
                ...
                products.map(function (product) {
                    ...
                    return (react_1.default.createElement(components_1.Section, { key: product.id },
                        react_1.default.createElement(components_1.Column, { style: { width: "64px" } }, typeof image !== "string" && image.url ?
                            react_1.default.createElement(components_1.Img, { src: image.url, width: '64', height: '64', alt: 'Product Image', style: productIcon })
                            : null),
                        react_1.default.createElement(components_1.Column, { style: { paddingLeft: "22px" } },
                            ...
                            product.description ?
                                react_1.default.createElement(components_1.Text, { style: productDescription }, product.description.length > 50 ?
