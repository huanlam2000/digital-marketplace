...
var yourOwnAndPurchased = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var user, products, ownProductFileIds, orders, purchasedOProductFileIds;
    var req = _b.req;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                orders = (_c.sent()).docs;
                purchasedOProductFileIds = orders
                    .map(function (order) {
                ...
                return [2 /*return*/, {
                        id: {
                            in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchasedOProductFileIds, true),
                        },
                    }];
        }
    });
